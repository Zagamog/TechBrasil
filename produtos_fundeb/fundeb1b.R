...
# We get the data generated by the simulador.fundeb package and save as df_ept_summary


# --- Step 11: Filter only UF-level data ---
matriculas_uf <- subset(matriculas, nchar(ibge) == 2)

# --- Step 12: Define columns ---
all_cols_ept <- c(
