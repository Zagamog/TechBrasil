...
\begin{document}
	...
	\begin{center}
		...
		\begin{tabular}{p{3.5cm}p{4.5cm}p{5cm}p{9cm}}
			...
			\midrule
			\texttt{df\_2a, df\_2b, df\_2c} \newline \texttt{df\_3a, df\_3b, df\_3c} \newline \texttt{df\_4a, df\_4b, df\_nd} & \texttt{prelims/produtos\_avila\_vidal/} \newline \texttt{avila\_vidal\_01a.R} & \texttt{rawdata/fgv/} \newline \texttt{fgv\_fin2b.xlsx} \newline (9 sheets, dados FGV/Vidal) & NM\_UF, DIVIDA, Distr\_FEF, Valor\_Abat, Saldo2025--2054, ApoFEF2025--2054, InvDir2025--2054, JurPag2025--2054 \\
			\texttt{dfcen\_val} & \texttt{prelims/produtos\_avila\_vidal/} \newline \texttt{avila\_vidal\_01a.R} & (gerado internamente) & A (abatimento), G (FEF), I (investimento), J (juros), valid, opcao \\
	...
	\begin{center}
		...
		\begin{tabular}{p{3.5cm}p{4.5cm}p{5cm}p{9cm}}
			...
			\texttt{df\_censo\_UF} & \texttt{prelims/produtos\_censo/} \newline \texttt{matriculas\_uf\_01a.R} & Microdados Censo Escolar \newline 2007--2024 & Agregações por UF, ano, dependência administrativa \\
			\texttt{df\_pibmunis} & \texttt{prelims/municipios/} \newline \texttt{TB\_municipios\_01a.R} & \texttt{working/sqlite/} \newline \texttt{TB\_municipios.sqlite} & PIB por município 2002--2021 (43 variáveis) \\
			\texttt{df\_residuals\_ols} & \texttt{produtos\_rais/} \newline \texttt{modelo\_ept\_03a.R} & Modelo OLS com efeitos fixos & Resíduos do modelo, fitted values, variáveis explicativas \\
			\bottomrule
		\end{tabular}
	\end{center}
	...
	\begin{center}
		...
		\begin{tabular}{p{3.5cm}p{4.5cm}p{5cm}p{9cm}}
			...
			\texttt{df\_cbocod\_mun23} \newline \texttt{df\_cbocod\_mun24} & \texttt{produtos\_rais/} \newline \texttt{rais\_apo\_04a.R} & RAIS vínculos municipais & Emprego formal por CBO e município \\
			\bottomrule
		\end{tabular}
	\end{center}
	...
	\begin{center}
		...
		\begin{tabular}{p{3.5cm}p{4.5cm}p{5cm}p{9cm}}
			...
			\texttt{rais\_cbo6\_uf23/24} & \texttt{prelims/rais/rais\_02a.R} & RAIS microdados & Emprego por CBO 6-dígitos e UF \\
			...
			\texttt{caged\_rais\_cnct\_} \newline \texttt{2020\_2024\_shiny} & \texttt{prelims/caged/} \newline \texttt{caged\_rais\_02a.R} & CAGED + RAIS 2020--2024 & Fluxos admissão/desligamento, salários, rotatividade por curso \\
			\bottomrule
		\end{tabular}
	\end{center}
	...
	\begin{center}
		\begin{tikzpicture}[
			...
			% Row 2: Scripts
			\node[scriptbox, below=of ibge] (s1) {pop00\_70\_01a.R\\TB\_municipios\_01a.R\\codes\_ibge\_01a.R\\econ\_dynam\_01a.R};
			\node[scriptbox, below=of inep] (s2) {matriculas\_uf\_01a.R\\censo\_garabed\_01a.R\\prepara\_censo\_*.R};
			\node[scriptbox, below=of mte] (s3) {rais\_01a.R / rais\_02a.R\\rais\_apo\_[01-04]*.R\\caged\_rais\_01a.R\\caged\_rais\_02a.R};
			\node[scriptbox, below=of mec] (s4) {qbq\_01a.R\\qbq\_02a.R\\qbq\_03a.R};
			\node[scriptbox, below=of fgv] (s5) {avila\_vidal\_01a.R};
			\node[scriptbox, below=of pnad] (s6) {pnad\_ocups\_01a.R\\pnad\_ocups\_01b.R};
			...
			\node[outputbox, below=3.0cm of ai] (o4) {*\_matches2.rda\\qbq\_ocup\_cmento1.rda\\cbo\_short\_names.rda\\df\_mat\_*.rda};
	...
	\begin{longtable}{p{4.5cm}p{5.5cm}p{4.5cm}p{7cm}}
		...
		pop01\_70b.rda & prelims/população/pop00\_70\_01a.R & working/ibge/ & A1, A2 \\
		
		\multicolumn{4}{l}{\cellcolor{tabA!20}\textbf{CÓDIGOS GEOGRÁFICOS}} \\
		df\_codes\_ibge.rda & prelims/mapas/codes\_ibge\_01a.R & working/ibge/ & A2, D1, D2, D3, E1 \\
		
		\multicolumn{4}{l}{\cellcolor{tabB!20}\textbf{FINANÇAS PROPAG}} \\
		df\_2a.rda \ldots{} df\_4b.rda (8 arquivos) & avila\_vidal\_01a.R & working/fgv/ & B1, B2, B3 \\
		df\_nd.rda & avila\_vidal\_01a.R & working/fgv/ & B1, B2, B3 \\
		dfcen\_val.rda & avila\_vidal\_01a.R & working/fgv/ & B1, B2, B3 \\
		
		\multicolumn{4}{l}{\cellcolor{tabC!20}\textbf{CENSO ESCOLAR / META 11}} \\
		df\_censo\_UF.rda & matriculas\_uf\_01a.R & working/mec\_inep/ & B1, C1, C2, C3 \\
		...
		df\_pibmunis.rda & TB\_municipios\_01a.R & working/ibge/ & C4, D1 \\
		df\_residuals\_ols.rda & modelo\_ept\_03a.R & working/rais/ & C4 \\
		
		\multicolumn{4}{l}{\cellcolor{tabD!20}\textbf{DINAMISMO E APLs}} \\
		MUN\_dyna02\_21.rda & econ\_dynam\_01a.R & working/ibge/ & D1 \\
		...
		df\_cbocod\_mun23.rda & rais\_apo\_04a.R & working/rais/ & D3 \\
		df\_cbocod\_mun24.rda & rais\_apo\_04a.R & working/rais/ & D3 \\
		
		\multicolumn{4}{l}{\cellcolor{tabD!20}\textbf{PNAD-C FORMALIDADE}} \\
		pnadc\_*\_uf\_formalidade\_*.csv & pnad\_ocups\_01a.R / 01b.R & working/pnad/ & D3 \\
		...
		rais\_cbo6\_uf23.rda & rais\_02a.R & working/rais/ & E1 \\
		rais\_cbo6\_uf24.rda & rais\_02a.R & working/rais/ & E1 \\
		...
		caged\_rais\_cnct\_2020\_2024\_shiny.rda & caged\_rais\_02a.R & working/mintraemp/ & E2 \\
		df\_ranking\_cursos\_caged\_rais.rda & caged\_rais\_02a.R & working/mintraemp/ & E2 \\
	...
	\begin{verbatim}
		...
		│   ├── caged/
		│   │   ├── caged_rais_01a.R            # Importa CAGED+RAIS por mun/CBO6
		│   │   ├── caged_rais_02a.R            # Preprocessa para Shiny
		│   │   └── caged_rais_demanda_01a.R    # Demanda E2
		│   ├── mapas/
		│   │   └── codes_ibge_01a.R            # Geocodes IBGE
		│   ├── mec/
		│   │   ├── censo_garabed_01a.R         # Meta 11, Garabed
		│   │   ├── cnct_01a.R                  # Processa catálogo CNCT
		│   │   ├── prepara_censo_escolar_01a.R # Censo Escolar geral
		│   │   └── prepara_censo_escolar_tecnico_01a.R  # Censo suplemento técnico
		│   ├── municipios/
		│   │   ├── TB_municipios_01a.R         # PIB municipal, geocodes
		│   │   └── econ_dynam_01a.R            # Dinamismo econômico
		│   ├── pnad/
		│   │   ├── pnad_ocups_01a.R            # Formalidade PNAD-C
		│   │   └── pnad_ocups_01b.R            # Formalidade PNAD-C (cont.)
		│   ├── população/
		│   │   └── pop00_70_01a.R              # Projeções populacionais IBGE
		│   ├── produtos_avila_vidal/
		│   │   └── avila_vidal_01a.R           # Simulações financeiras FGV
		│   ├── produtos_censo/
		│   │   └── matriculas_uf_01a.R         # Agregações Censo por UF
		...
		│   │   └── qbq_cnct_pipeline.html     # Documentação pipeline (.Rmd → .html)
		│   └── rais/
		│       ├── rais_01a.R                  # Download/processa RAIS
		│       └── rais_02a.R                  # Processa vínculos por CBO/UF
		│
		├── produtos_rais/                       # Scripts que geram produtos analíticos
		│   ├── modelo_ept_01a.R                # Modelo EPT (preparação)
		│   ├── modelo_ept_03a.R                # Modelo final OLS
		│   ├── rais_apo_01a.R                  # APL — cálculo QL
		│   ├── rais_apo_01b.R                  # APL — cálculo QL (cont.)
		│   ├── rais_apo_02MUNI.R              # APL — dados municipais
		│   ├── rais_apo_02UF.R                # APL — dados UF
		│   ├── rais_apo_03MUNI.R              # APL — matching cursos (municipal)
		│   ├── rais_apo_03UF.R                # APL — matching cursos (UF)
		│   └── rais_apo_04a.R                 # Informalidade por município
		│
		├── docs/
