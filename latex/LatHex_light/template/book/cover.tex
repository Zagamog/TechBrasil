\newcommand{\coverpage}[5]{
    ...
    %%%%%%%%%%%%%%%%%%%% Title + Subtitle %%%%%%%%%%%%%%%%%%%%
    \drawtext{\Huge\textsc{\textbf{#1}}\\\Large\textsc{#2}}{$(current page.center)+(4,-4)$}{4cm}{-60}{text=fg,align=right,font=\headingfontfamily};
    ...
    \drawhexagon{}{$(current page.west)+(2.5,-5)$}{2.5 cm}{0}{accent!60,draw,line width=2pt};
     % Text node with multi-line support
    \node[anchor=center,text=fg,font=\Large\headingfontfamily,align=center] at ($(current page.west)+(2.5,-5)$) {#5};
