...
dotenv::load_dot_env("D:/Country/Brazil/TechBrazil/.env")
...
# Save the file
save(df_codes_ibge, file = "D:/Country/Brazil/TechBrazil/working/ibge/df_codes_ibge.rda")

# Upload to Amazon S3

tryCatch({
  put_object(file = "D:/Country/Brazil/TechBrazil/working/ibge/df_codes_ibge.rda", object = "working/ibge/df_codes_ibge.rda",
             bucket = bucket_name)
